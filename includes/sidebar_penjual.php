...
<ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
    ...
    <a class="sidebar-brand d-flex align-items-center justify-content-start px-3 py-4 normal-link" href="../penjual/dashboard.php">
    ...
    <li class="nav-item <?= ($page == 'dashboard.php' || $page == '') ? 'active' : ''; ?>">
        <a class="nav-link normal-link" href="../penjual/dashboard.php">
    ...
    <li class="nav-item <?= ($page == 'penawaran_mobil.php') ? 'active' : ''; ?>">
        <a class="nav-link ajax-link" href="../penjual/penawaran_mobil.php">
