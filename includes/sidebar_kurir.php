...
<ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
    ...
    <a class="sidebar-brand d-flex align-items-center justify-content-start px-3 py-4 normal-link" href="../kurir/dashboard.php">
        <div class="sidebar-brand-icon">
            <div class="bg-white shadow-sm rounded-circle d-flex align-items-center justify-content-center" style="width:52px; height:52px;">
                <i class="fas fa-truck text-primary" style="font-size:21px;"></i>
            </div>
        </div>
    ...
    <li class="nav-item <?= ($page == 'dashboard.php' || $page == '') ? 'active' : ''; ?>">
        <a class="nav-link normal-link" href="../kurir/dashboard.php">
    ...
    <li class="nav-item <?= ($page == 'pengiriman_mobil.php') ? 'active' : ''; ?>">
        <a class="nav-link ajax-link" href="../kurir/pengiriman_mobil.php">
